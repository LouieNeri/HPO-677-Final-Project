...
\protect\phantomsection\label{cell-fig-conceptual-model}
\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-conceptual-model-1.pdf}}

}

\caption{\label{fig-conceptual-model}Conceptual model. The primary
causal pathway runs from treatment through mediators to outcomes.
Confounders influence both treatment selection and outcomes, creating
the need for propensity score adjustment.}

\end{figure}%

\textsubscript{Source:
\href{https://LouieNeri.github.io/HPO-677-Final-Project/index.qmd.html}{Article
Notebook}}
